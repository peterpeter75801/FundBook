...
public class FundingStatusDAOImplTests {
    ...
    public void testCreateDefault() {
        String[] expectedData = { "1,0,2019,1,21,\"預設可動用資金\",0,\"\",0,\"false\"" };
        String[] actualData = new String[ 1 ];
        try {
            // testing creating default funding status data with incorrect ID
            fundingStatusDAO.createDefault( new FundingStatus( 5, '0', 2019, 01, 21, "預設可動用資金", 0, "", 0, false ) );
            ...
            fundingStatusDAO.createDefault( new FundingStatus( 1, '0', 2019, 01, 21, "預設可動用資金", 0, "", 0, false ) );
    ...
    public void testInsert() throws IOException {
        String[] expectedData = {
                "1,D,2017,12,30,\"中華郵政 #12345671234567\",10000,\"\",0,\"false\"", 
                "2,C,2017,12,30,\"隨身現金\",5000,\"\",0,\"false\"", 
                "3,T,2017,11,28,\"土地銀行 #01234560123456\",100000,\"\",0,\"false\"", 
                "4,D,2017,10,1,\"土地銀行 #01234567890123\",50000,\"\",0,\"false\"", 
                "5,T,2017,10,28,\"土地銀行 #11223344556677\",200000,\"\",0,\"false\"" };
        String[] actualData = new String[ 5 ];
        try {
            fundingStatusDAO.insert( new FundingStatus( 0, 'D', 2017, 12, 30, "中華郵政 #12345671234567", 10000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'C', 2017, 12, 30, "隨身現金", 5000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'T', 2017, 11, 28, "土地銀行 #01234560123456", 100000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'D', 2017, 10, 01, "土地銀行 #01234567890123", 50000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'T', 2017, 10, 28, "土地銀行 #11223344556677", 200000, "", 0, false ) );
    ...
    public void testFindOne() throws IOException {
        FundingStatus expect = new FundingStatus( 5, 'T', 2017, 10, 28, "土地銀行 #11223344556677", 200000, "", 0, false );
    ...
    public void testFindAll() throws IOException {
        ...
        expectedDataList.add( new FundingStatus( 1, 'D', 2017, 12, 30, "中華郵政 #12345671234567", 10000, "", 0, false ) );
        expectedDataList.add( new FundingStatus( 2, 'C', 2017, 12, 30, "隨身現金", 5000, "", 0, false ) );
        expectedDataList.add( new FundingStatus( 3, 'T', 2017, 11, 28, "土地銀行 #01234560123456", 100000, "", 0, false ) );
        expectedDataList.add( new FundingStatus( 4, 'D', 2017, 10, 01, "土地銀行 #01234567890123", 50000, "", 0, false ) );
        expectedDataList.add( new FundingStatus( 5, 'T', 2017, 10, 28, "土地銀行 #11223344556677", 200000, "", 0, false ) );
    ...
    public void testUpdate() throws IOException {
        ...
        expectedDataList.add( "1,D,2017,12,30,\"中華郵政 #12345671234567\",12000,\"\",0,\"false\"" );
        expectedDataList.add( "2,C,2017,12,30,\"隨身現金\",5000,\"\",0,\"false\"" );
        expectedDataList.add( "3,T,2017,11,28,\"土地銀行 #01234560123456\",100000,\"\",0,\"false\"" );
        expectedDataList.add( "4,D,2017,10,1,\"土地銀行 #01234567890123\",50000,\"\",0,\"false\"" );
        expectedDataList.add( "5,T,2017,10,28,\"土地銀行 #11223344556677\",200000,\"\",0,\"false\"" );
        ...
        try {
            ...
            FundingStatus modifiedData = new FundingStatus( 1, 'D', 2017, 12, 30, "中華郵政 #12345671234567", 12000, "", 0, false );
    ...
    public void testDelete() throws IOException {
        List<String> expectedDataList = new ArrayList<String>();
        expectedDataList.add( "1,D,2017,12,30,\"中華郵政 #12345671234567\",10000,\"\",0,\"false\"" );
        expectedDataList.add( "2,C,2017,12,30,\"隨身現金\",5000,\"\",0,\"false\"" );
        expectedDataList.add( "3,T,2017,11,28,\"土地銀行 #01234560123456\",100000,\"\",0,\"false\"" );
        expectedDataList.add( "4,D,2017,10,1,\"土地銀行 #01234567890123\",50000,\"\",0,\"false\"" );
        List<String> actualDataList = new ArrayList<String>();
        ...
        try {
            ...
            FundingStatus deletedData = new FundingStatus( 5, 'T', 2017, 10, 28, "土地銀行 #11223344556677", 200000, "", 0, false );
    ...
    public void testRefreshOrderNo() throws IOException {
        List<String> expectedDataList = new ArrayList<String>();
        expectedDataList.add( "1,D,2017,12,30,\"中華郵政 #12345671234567\",10000,\"\",1,\"false\"" );
        expectedDataList.add( "2,C,2017,12,30,\"隨身現金\",5000,\"\",2,\"false\"" );
        expectedDataList.add( "3,T,2017,11,28,\"土地銀行 #01234560123456\",100000,\"\",3,\"false\"" );
        expectedDataList.add( "4,D,2017,10,1,\"土地銀行 #01234567890123\",50000,\"\",4,\"false\"" );
        expectedDataList.add( "5,T,2017,10,28,\"土地銀行 #11223344556677\",200000,\"\",5,\"false\"" );
        List<String> actualDataList = new ArrayList<String>();
    ...
    public void testGetActiveCount() {
        ...
        try {
            ...
            fundingStatusDAO.insert( new FundingStatus( 0, 'T', 2017, 11, 28, "土地銀行 #01234560123456", 100000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'D', 2017, 10, 01, "土地銀行 #01234567890123", 50000, "", 0, false ) );
            fundingStatusDAO.insert( new FundingStatus( 0, 'T', 2017, 10, 28, "土地銀行 #11223344556677", 200000, "", 0, true ) );
            
            actual = fundingStatusDAO.getActiveCount();
            assertEquals( expect, actual );
        } catch( Exception e ) {
            e.printStackTrace();
            assertTrue( e.getMessage(), false );
    ...
    public void testMoveToBottom() {
        ...
        try {
            ...
            fundingStatusDAO.refreshOrderNo();
            fundingStatusDAO.moveToBottom( 2 );
